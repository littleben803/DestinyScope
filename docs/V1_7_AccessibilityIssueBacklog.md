...
- 当前无 open issue。
- 当前无 P0 / P1 / P2 需要修复的问题。
- V1.7 阶段 3 / 4 / 5 无需执行代码修复。
- 如果后续新增人工反馈，应新增 issue，并将 `status` 设置为 `open`，再进入对应修复阶段。

## V1.7 收尾状态

- 当前所有条目均为 `verified-pass`。
- 当前无 open issue。
- 当前无 P0 / P1 / P2 需要修复的问题。
- V1.7 阶段 7 未新增虚假 issue。
- 如未来恢复 TestFlight 或 App Store release 准备，应重新执行多设备和无障碍验收，并按真实结果更新本 backlog。
